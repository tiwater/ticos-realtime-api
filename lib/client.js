...
export class RealtimeClient extends RealtimeEventHandler {
  ...
  updateSession(sessionConfig) {
    ...
    if (sessionConfig.model) { // test the config structure for stardust
  ...
  updateStardustSession(sessionConfig) {
    ...
    // Update member variables similar to updateOpenaiSession
    sessionConfig.model?.modalities !== void 0 && (this.sessionConfig.modalities = sessionConfig.model.modalities);
    sessionConfig.model?.instructions !== void 0 && (this.sessionConfig.instructions = sessionConfig.model.instructions);
    sessionConfig.speech?.voice !== void 0 && (this.sessionConfig.voice = sessionConfig.speech.voice);
    sessionConfig.hearing?.input_audio_format !== void 0 && (this.sessionConfig.input_audio_format = sessionConfig.hearing.input_audio_format);
    sessionConfig.speech?.output_audio_format !== void 0 && (this.sessionConfig.output_audio_format = sessionConfig.speech.output_audio_format);
    sessionConfig.hearing?.input_audio_transcription !== void 0 && (this.sessionConfig.input_audio_transcription = sessionConfig.hearing.input_audio_transcription);
    sessionConfig.hearing?.turn_detection !== void 0 && (this.sessionConfig.turn_detection = sessionConfig.hearing.turn_detection);
    sessionConfig.model?.tools !== void 0 && (this.sessionConfig.tools = sessionConfig.model.tools);
    sessionConfig.model?.tool_choice !== void 0 && (this.sessionConfig.tool_choice = sessionConfig.model.tool_choice);
    sessionConfig.model?.temperature !== void 0 && (this.sessionConfig.temperature = sessionConfig.model.temperature);
    sessionConfig.model?.max_response_output_tokens !== void 0 && (this.sessionConfig.max_response_output_tokens = sessionConfig.model.max_response_output_tokens);

    // Handle tools similar to updateOpenaiSession
    if (sessionConfig.model.tools) {
      ...
      sessionConfig.model.tools = useTools;
    }

    if (this.realtime.isConnected()) {
      this.realtime.send('session.update', { session: sessionConfig });
    }
  }
