...
export class RealtimeUtils {
   ...
   * @param {ArrayBuffer|Int16Array|Float32Array} audioData
   * @returns {string}
   */
  static arrayBufferToBase64(audioData) {
    let bytes;
    if (audioData instanceof Float32Array) {
      bytes = new Uint8Array(this.floatTo16BitPCM(audioData));
      ...
      throw new Error(`audioData must be an ArrayBuffer, Int16Array, or Float32Array`);
    }
    let binary = '';
