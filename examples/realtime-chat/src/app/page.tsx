      ...
      <div className="w-full mx-auto flex flex-col gap-4 h-screen p-4">
        <header className="flex flex-col md:flex-row items-center justify-between p-4 rounded-lg flex-shrink-0">
          <div className="text-center md:text-left">
            ...
            <p className="text-muted-foreground mt-2 mx-auto md:mx-0 text-sm md:text-base">
              A demonstration of the <a href="https://github.com/tiwater/ticos-realtime-api" target="_blank" rel="noopener noreferrer" className="underline">Ticos Realtime API</a> using Next.js 15.3, React 19, Tailwind CSS v4, and shadcn/ui.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-grow">
          ...
          <div className="h-[calc(100vh-160px)] overflow-hidden shadow-md rounded-lg border bg-card">
            <EventLog />
          </div>
        </div>
      </div>
